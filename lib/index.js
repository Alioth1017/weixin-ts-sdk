(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@alioth_91/weixin-ts-sdk'] = {}));
  ...
  var wx$1 = weixinJsSdk.exports;

  async function useWxJsSdk(options) {
      options && (await config(options));
      return { wx: wx$1, getLocation, wxPay, wxScanQRCode };
  }
  ...
  const config = (options) => {
      const promise = (resolve, reject) => {
          try {
              let { signature, nonceStr, timestamp, appId, jsApiList, openTagList } = options;
   ...
   * @param {*} otpions
   */
  const wxScanQRCode = ({ needResult = undefined }) => {
      const promise = (resolve, reject) => {
          if (!$wx) {
              return reject("[JS-SDK] 未初始化完毕");
          }
          wx$1.scanQRCode({
              needResult: needResult === undefined ? 1 : 0,
  ...
  exports.useWxJsSdk = useWxJsSdk;
  exports.wxPay = wxPay;
  exports.wxScanQRCode = wxScanQRCode;
